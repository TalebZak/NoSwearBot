...
@bot.command(description='blacklists a word if it was not blacklisted already'
    , brief='blacklists a word')
...
@bot.command(description='lists all the words that were blacklisted in the server'
    , brief='lists all blacklisted words')
